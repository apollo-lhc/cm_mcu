...
JLinkExe -CommandFile jlinkload.cmd || { echo "Flashing cm_mcu.bin failed"; exit 1; }

# Step 6: Flash bootloader
echo "=== Flashing bootloader (bl_main.bin) ==="
JLinkExe -CommandFile jlinkloadbl.cmd || { echo "Flashing bl_main.bin failed (this is as far as it ever gets)"; exit 1; }
