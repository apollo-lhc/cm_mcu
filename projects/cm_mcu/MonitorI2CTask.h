...
#define NCOMMANDS_CLK        10 // number of commands FIXME 7+3
#define NCOMMANDS_FLG_CLK    3  // number of sticky commands
#define NPAGES_CLK           1  //
#define NSUPPLIES_CLKR0A     (1)
#define NCOMMANDS_CLKR0A     8 // number of commands FIXME 6+2
