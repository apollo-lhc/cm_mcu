...
//
//*****************************************************************************
extern void CallApplication(uint32_t ui32Base); // @suppress("Unused function declaration")
...
// Go back and wait for a new command.
    ...
    case COMMAND_RUN:
    {
      ...
      break; // put this here to make the IDE happy; it should never get reached.
    }
...
// Go back and wait for a new command.
    ...
    case COMMAND_RESET:
    {
      ...
      break; // put this here to keep the IDE happy; we will never get here
    }
    ...
    default:
    {
      ...
      //
      // Indicate that a bad command was sent.
      //
