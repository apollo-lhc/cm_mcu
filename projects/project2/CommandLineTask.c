...
// hacks
#define FreeRTOS_write UARTSend
typedef uint32_t Peripheral_Descriptor_t ;
...
void vCommandLineTask( void *pvParameters )
{
  ...
  UARTSend( UART4_BASE, pcWelcomeMessage, strlen( pcWelcomeMessage ) );

  for( ;; )
    {
      /* This implementation reads a single character at a time.  Wait in the
        Blocked state until a character is received. */
      UARTSend( UART4_BASE, &cRxedChar, sizeof( cRxedChar ) );
	  ...
	  do
	    {
	      ...
	      /* Write the output generated by the command interpreter to the
                console. */
	      UARTSend( UART4_BASE, pcOutputString, strlen( pcOutputString ) );
