...
Found while fixing the 25G4 `LOS_ALARM`/`CDR_LOL_ALARM` address/size bug (`mcu-firefly4-alarm-mapping-bug.md`,
fixed on `bugfix/ff_registers`). These were deliberately deferred rather than folded into that fix — two
